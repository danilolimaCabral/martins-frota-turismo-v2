...
export default function AdminOtimizacaoAvancada() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-4 md:p-8">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-3xl font-bold text-slate-900">Otimização</h1>
        </div>
        <p className="text-slate-600">Gerenciamento de Otimização</p>
      </div>
